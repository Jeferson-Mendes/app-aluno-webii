...
const EditMeet:React.FC = () => {
    ...
    React.useEffect(() => {
        console.log(routeParams.meetId);
    ...
    const handleEditMeet = async () => {
        ...
        try {
            ...
            const res = await api.put(`encontros/atualizar/${routeParams.meetId}`, meetData);
    ...
    return (
        <View style={styles.container}>
          <View style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <Text style={{ fontSize: 20, textAlign: 'center', fontWeight: 'bold' }}>Edite seu Encontro</Text>
              ...
              <View style={styles.buttonContainer}>
                  ...
                  <Button color={'#23A817'} title='Salvar' onPress={handleEditMeet}/>
              </View>
          </View>
        </View>
    )
